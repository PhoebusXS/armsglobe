...
function attachMarkerToCountry( countryName, importance ){
	...
	if(country.exportedAmount > 0 && country.importedAmount > 0) {
	   importExportText += "ALERTS:&nbsp;" + numberWithCommas(country.importedAmount) + "<br />" +
	                       "ATTACKS:&nbsp;"+numberWithCommas(country.exportedAmount);
	} else if(country.exportedAmount > 0 && country.importedAmount == 0) {
	   importExportText += "ATTACKS:&nbsp;"+numberWithCommas(country.exportedAmount)+"<br />&nbsp;";
	} else if(country.exportedAmount == 0 && country.importedAmount > 0) {
	   importExportText += "ALERTS:&nbsp;"+numberWithCommas(country.importedAmount)+"<br />&nbsp;";
	}
